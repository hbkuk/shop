...
public class RestAssuredTemplate {
    ...
    public static ExtractableResponse<Response> get_요청_토큰_포함(String 토큰_정보, String 경로, HttpStatus 예상하는_상태코드) {
    ...
    public static ExtractableResponse<Response> put_요청_토큰_포함(String 토큰_정보, String 경로, Object 파라미터, HttpStatus 예상하는_상태코드) {
        return given().log().all()
                .header("Authorization", 토큰_정보)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .when()
    ...
    public static ExtractableResponse<Response> put_요청_토큰_미포함(String 경로, Object 파라미터, HttpStatus 예상하는_상태코드) {
        return given().log().all()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .when()
                .put(경로, 파라미터)
